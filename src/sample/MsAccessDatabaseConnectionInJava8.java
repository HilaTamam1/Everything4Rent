...
public class MsAccessDatabaseConnectionInJava8 {
    ...
    public void insertToProduct(String ownerName,String namePro, String type1, String location, String price,String loanDuration) {
        String sql = "INSERT INTO Product(ownerName,nameProduct,type1,location,price,loanDuration) " +"Values ('"+ownerName+"',"
                                                                                                    +"'"+namePro+"',"
                                                                                                                      +"'"+type1+"',"
                                                                                                                     +"'"+location+"',"
                                                                                                                      +"'"+price+"',"
